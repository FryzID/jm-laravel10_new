...
<div class="modal fade" id="form-edit{{ $siswa->siswa_id }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-outline my-3">
                        ...
                        <input type="text" class="form-control" name="nis" id="exampleFormControlInput1"
                            placeholder="Input..." value="{{ old('nis', $siswa->nis) }}" required>
                    </div>
                    <div class="input-group input-group-outline my-3">
                        <label class="form-label">Nama Siswa</label>
                        <input type="text" class="form-control" name="nama_siswa" id="exampleFormControlInput1"
                            placeholder="Input..." value="{{ old('nama_siswa', $siswa->nama_siswa) }}" required>
                    </div>
                    <div class="input-group input-group-outline my-3">
