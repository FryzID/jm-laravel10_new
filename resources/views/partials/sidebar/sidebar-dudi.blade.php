<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('dudi/dashboard') ? 'active bg-gradient-success' : "" }}"
                    href="/dudi/dashboard">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Request::is('dudi/siswapkl') ? 'active bg-gradient-success' : "" }}"
                    href="/dudi/siswapkl">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
