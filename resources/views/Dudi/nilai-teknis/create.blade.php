...
<div class="modal fade" id="form-create" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="form-valide" action="/dudi/nilai-teknis" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-outline my-3">
                        ...
                        <input type="text" class="form-control" name="nilai" id="exampleFormControlInput1" required>
                    </div>
                </div>
