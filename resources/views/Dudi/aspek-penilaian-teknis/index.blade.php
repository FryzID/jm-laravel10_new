                                ...
                                <td class="budget">
                                    <span class="center">
                                        <a class="btn btn-circle btn-info border-0 m-1" onclick="getDetail()"
                                            data-toggle="modal" data-target="#form-detail{{ $aspekpenilaianteknis->aspek_penilaian_teknis_id }}"><i
                                                class="fa fa-eye"></i></a>
                                        <button class="btn btn-circle btn-primary border-0 m-1" data-bs-toggle="modal"
                                            data-bs-target="#form-edit{{ $aspekpenilaianteknis->aspek_penilaian_teknis_id }}"><i
                                                class="fa fa-pen"></i></button>
                                        <form action="/dudi/nilai-nonteknis/{{ $aspekpenilaianteknis->aspek_penilaian_teknis_id }}" method="post"
                                            class="d-inline">
                                            @method('DELETE')
                                            @csrf
...
<!-- MODAL -->
@include('Dudi.aspek-penilaian-teknis.create')
@include('Dudi.aspek-penilaian-teknis.edit')
