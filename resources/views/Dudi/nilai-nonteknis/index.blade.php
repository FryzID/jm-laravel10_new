                ...
                <div class="table-responsive">
                    <table class="table align-items-center mb-0 text-center" id="dataTable" width="100%"
                        ...
                        <tbody>
                            ...
                            @if($nilainonteknis->siswapkl->dudi->dudi_id == Auth::guard('dudi')->user()->dudi_id)
                            <tr>
                                ...
                                <td class="budget">
                                    <span class="center">
                                        ...
                                        <form action="/humas/nilai-nonteknis/{{ $nilainonteknis->nilai_nonteknis_id }}" method="post"
                                            class="d-inline">
                                            @method('DELETE')
                                            @csrf
...
<!-- MODAL -->
@include('Dudi.nilai-nonteknis.create')
@include('Dudi.nilai-nonteknis.edit')
